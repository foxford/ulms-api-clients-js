...
const casesWithPayload = [['put'], ['post'], ['patch']]

const casesWithoutPayload = [['get'], ['delete']]
...
describe('Http client should work', () => {
  ...
  it('json method should work', async () => {
    const fakeJson = jest.fn().mockImplementation(
      () =>
    ...
    const fakeText = jest
      .fn()
      .mockImplementation(() => Promise.reject(new Error('To Text Error')))
